...
function change_play() {
    $('.follow-content').css('background', 'url("/wp-content/themes/danhdev_1/templates/assets/img/play.svg") no-repeat 0 center');
}

function change_pause() {
    $('.follow-content').css('background', 'url("/wp-content/themes/danhdev_1/templates/assets/img/pause.svg") no-repeat 0 center');
}
/*scroll show contact*/
...
function control_show(data, i) {
    if (data != undefined) {
        ...
        if (data.dac_diem != "" && data.dac_diem != undefined) {
            result += '<div class="card card-1" style=" width: 100%; margin-top: 15px; padding: 15px; background: #e8eaf6; " >';
...
function show_popup(id, size, price, title, img) {
    ...
    popup_temp += img + '" style=" max-width: 100%; height: auto; display: inline-block; vertical-align: middle; "> </div> <div class="devvn-popup-info"> <span class="devvn_title">';
