<?php 
/*
Plugin Name: Tạo nội dung bằng tools
...
add_action('admin_menu', 'qc_plugin_setup_menu_tools');
function qc_plugin_setup_menu_tools(){
    add_menu_page( 'Contents Tools', 'Contents Tools', 'manage_options', 'contents-tools', 'qc_init_tools',plugin_dir_url(__FILE__).'/gg.png',2 );
}
 
function qc_init_tools(){
